...
FAKE_DEVS = list(map(int, os.environ.get("FAKE_DEVS", "1950977437").split()))
SAWERIA_EMAIL = os.environ.get("SAWERIA_EMAIL", "yogz@gmail.com")
SAWERIA_USERID = os.environ.get(
    "SAWERIA_USERID", "50e13cfg97-a6sa06-4d31ss-87ss8d-2fcssa38b41c6a5"
)
SAWERIA_USERNAME = os.environ.get("SAWERIA_USERNAME", "putms")
API_KEY = [
